...
if(cross == "left"):
    ...
    if(choose == "wait"):
        color = input("You arrive at a the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which color do you choose?\n")
        if(color == "red"):
            print("You burned by the fire. Game Over.")
        elif(color == "yellow"):
            print("You Win!!")
        elif(color == "blue"):
